...
const SwitchDarkMode: React.FC<SwitchDarkModeProps> = ({ className = "" }) => {
  ...
  return (
    <button
      ...
      className={`self-center text-2xl md:text-3xl w-12 h-12 rounded-full text-neutral-700 text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 focus:outline-none flex items-center justify-center ${className}`}
    >
